      ...
      <div className="w-full max-w-4xl bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 md:flex-row flex-col gap-8 flex">
        <div className="flex-1 flex flex-col items-center md:items-start">
          <Link to="/" className="flex items-center whitespace-nowrap text-lg font-semibold text-gray-800 dark:text-gray-200 transition-opacity duration-150 hover:opacity-90">
            <img src="https://files.oaiusercontent.com/file-kESpRwyr4ScEbgOlePGO01dz?se=2024-11-08T08%3A07%3A41Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3De1e76f65-59ef-4a4c-a250-443c51ff4950.webp&sig=Jp3LclKgtHfjGbKxgzLTy/Etf/KcWYJ7rocyX7uy4Hc%3D" alt="Logo" className="w-20 h-20 mr-2 rounded-full object-cover shadow-md" />
